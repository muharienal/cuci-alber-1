<?php $__env->startSection('title', 'Form Cuci Alat Berat - Cuci Alber'); ?>
...
<div class="card-shell">
    ...
    <div class="card-body-pad">
        <div class="steps-track" id="stepIndicator">
            <?php $__currentLoopData = ['Lokasi', 'Unit', 'Petugas', 'Foto', 'Ringkasan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="step-dot" data-step="<?php echo e($i + 1); ?>">
                    <div class="step-circle"><?php echo e($i + 1); ?></div>
        ...
        <form method="POST" action="<?php echo e(route('form.store')); ?>" enctype="multipart/form-data" id="formCuciAlber">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="chip-grid">
                            <?php $__currentLoopData = $zonas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="chip-grid-item">
                                    <input type="radio" class="chip-input" name="zona_id" id="zona<?php echo e($zona->id); ?>" value="<?php echo e($zona->id); ?>" required>
                                    <label class="chip-label" for="zona<?php echo e($zona->id); ?>"><?php echo e($zona->nama); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 gy-3">
                        <div class="col-sm-6">
                            ...
                            <select name="pengawas_id" id="pengawas_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $pengawasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->id); ?>"><?php echo e($p->nama); ?><?php echo e($p->wilayah ? ' (' . $p->wilayah . ')' : ''); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row g-2">
                                <?php $__currentLoopData = ['1','2','3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-4">
                                        <input type="radio" class="chip-input" name="shift" id="shift<?php echo e($sh); ?>" value="<?php echo e($sh); ?>" required>
                                        <label class="chip-label" for="shift<?php echo e($sh); ?>">Shift <?php echo e($sh); ?></label>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="operator_nd_id" id="operator_nd" class="operator-select form-select"><?php echo $operatorOptionsHtml; ?></select>
                        </div>

                        <div class="col-sm-6">
                            <label class="form-label">Operator Grup A</label>
                            <select name="operator_grup_a_id" id="operator_grup_A" class="operator-select form-select"><?php echo $operatorOptionsHtml; ?></select>
                        </div>

                        <div class="col-sm-6">
                            <label class="form-label">Operator Grup B</label>
                            <select name="operator_grup_b_id" id="operator_grup_B" class="operator-select form-select"><?php echo $operatorOptionsHtml; ?></select>
                        </div>

                        <div class="col-sm-6">
                            <label class="form-label">Operator Grup C</label>
                            <select name="operator_grup_c_id" id="operator_grup_C" class="operator-select form-select"><?php echo $operatorOptionsHtml; ?></select>
                        </div>

                        <div class="col-sm-6">
                            <label class="form-label">Operator Grup D</label>
                            <select name="operator_grup_d_id" id="operator_grup_D" class="operator-select form-select"><?php echo $operatorOptionsHtml; ?></select>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\cuci-alber\resources\views/public/form.blade.php ENDPATH**/ ?>