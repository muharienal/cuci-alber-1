    ...
    <div class="login-card card">
        <div class="card-body p-4 p-sm-5">
            ...
            <div class="text-center mt-3">
                <a href="<?php echo e(route('form.index')); ?>" class="small text-decoration-none" style="color: var(--navy-600);">&larr; Kembali ke form publik</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\cuci-alber\resources\views/auth/login.blade.php ENDPATH**/ ?>