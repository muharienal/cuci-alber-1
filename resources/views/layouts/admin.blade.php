...
<head>
    ...
    <title>@yield('title', 'Admin') - Cuci Alber</title>
...
<body>
<div class="d-flex">
    {{-- ===== SIDEBAR: hanya tampil di layar besar (>= lg) ===== --}}
    ...
    <div class="main-wrap">
        {{-- ===== TOP APP BAR: hanya tampil di layar kecil (< lg) ===== --}}
        ...
        <main>
            <h4 class="mb-3 page-title">@yield('title')</h4>
...
{{-- ===== OFFCANVAS DRAWER: menu lengkap untuk mobile ===== --}}
...
{{-- ===== BOTTOM TAB BAR: navigasi cepat ala aplikasi native, mobile only ===== --}}
<nav class="bottom-tabbar d-lg-none">
    ...
    <a href="{{ route('admin.unitAlats.index') }}" class="tab-item {{ request()->routeIs('admin.unitAlats.*') ? 'active' : '' }}">
        <i class="bi bi-forklift"></i> Unit
    </a>
    <a href="{{ route('admin.operators.index') }}" class="tab-item {{ request()->routeIs('admin.operators.*') ? 'active' : '' }}">
        <i class="bi bi-people"></i> Operator
    </a>
    <a href="{{ route('admin.submissions.index') }}" class="tab-item {{ request()->routeIs('admin.submissions.*') ? 'active' : '' }}">
