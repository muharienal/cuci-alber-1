...
<head>
    ...
    <title>@yield('title', 'Cuci Alber')</title>
...
<body>
    <div class="page-wrap">
        ...
        <footer class="site-footer">
            &copy; {{ date('Y') }} IT - AB Wilayah 1 PT Petrokopindo Cipta Selaras
        </footer>
    </div>

    <a href="{{ route('admin.login') }}" class="admin-login-fab" target="_blank" rel="noopener">
